...
public class AccountRepositories : GeneralRepository<Account, string>
{
  ...
  public int Register(RegisterVM register)
  {
    ...
    /*var duplicate = _context.Universities.Where(u => u.Name == register.UniversityName).ToList();
  ...
  {
    var result = _accounts.Join(_context.Employees, a => a.NIK, e => e.NIK, (a, e) => new LoginVM
    {
      Email = e.Email,
      Password = a.Password
